(defproject bilig-server "0.0.1-SNAPSHOT"
  :description "bilig-server"
  ...
  :dependencies [[ch.qos.logback/logback-classic "1.4.14"]
                 ...
                 [markdown-clj "1.0.7"]
                 [metosin/compojure-api "2.0.0-alpha31" :exclusions [ring/ring-codec com.fasterxml.jackson.core/jackson-core]]
                 ...
                 [ring/ring-core "1.10.0" :exclusions [ring/ring-codec joda-time]]
                 [ring/ring-defaults "0.4.0" :exclusions [joda-time]]
                 [selmer "1.12.6"]
